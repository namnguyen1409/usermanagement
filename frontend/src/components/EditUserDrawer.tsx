        ...
        >
            ...
            >
                <Form.Item name="username" label="Tên đăng nhập"
                    rules={[{ min: 6, max: 20 }, { pattern: /^[a-zA-Z0-9_]+$/, message: "Chỉ chứa chữ cái, số, dấu gạch dưới" }]}>
                    <Input />
                </Form.Item>

                <Form.Item name="firstName" label="Họ"
                    rules={[{ min: 2, max: 20 }, { pattern: /^[\p{L}\s]+$/u, message: "Chỉ chứa chữ cái và khoảng trắng" }]}>
                    <Input />
                </Form.Item>
