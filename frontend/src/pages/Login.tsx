...
const Login = () => {
    ...
    return (
        <Card
            className="max-w-5xl mx-auto my-12 p-0 overflow-hidden shadow-lg rounded-xl border border-gray-200"
        >
                ...
                >
                    <div className="w-full max-w-sm p-8">
                        ...
                        >
                            ...
                            <Form.Item>
                                <Button type="primary" htmlType="submit" block loading={loading} className="rounded-md bg-blue-500 hover:bg-blue-600">
                                    Log in
                                </Button>
